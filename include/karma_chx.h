...
/*
  ...
  needed to interface to the chx_ routines in the Karma library.
...
/*  File:   main.c   */
EXTERN_FUNCTION (void chx_register_app_context, (XtAppContext context) );
EXTERN_FUNCTION (flag chx_manage,
...
EXTERN_FUNCTION (void chx_unmanage, (Channel channel) );
