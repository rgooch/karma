...
/*  This file contains all routines needed for manipulating a simple pixel
    ...
    contains the stub OpenGL code.


    Written by      Richard Gooch   29-OCT-1995

    Last updated by Richard Gooch   29-OCT-1995
...
/*STUB_FUNCTION*/
unsigned int kwin_open_gl_test_stereo (Display *display, int screen_number,
				       unsigned int visual, unsigned int depth)
{
    return (KWIN_OpenGL_NOT_AVAILABLE);
}   /*  End Function kwin_test_open_gl_stereo  */
