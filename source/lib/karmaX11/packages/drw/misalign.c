...
/*
  ...
  structure.
    ...
    Updated by      Richard Gooch   25-NOV-1993: Removed special code for
  K_UBYTE since these should be processed by the normal routines.

    Updated by      Richard Gooch   30-NOV-1993: Yet more support (and
  bugfixes) for blank values.

    Updated by      Richard Gooch   3-OCT-1994: Stripped check of log flags.
...
struct win_scale_type *win_scale;
{
	...
	(void) fprintf (stderr, "%s ended\tcpu time: %lu msecs\n",
