...
EXTERN_FUNCTION (double misalign__ds_convert_atomic, (char *datum,
						      unsigned int datum_type,
						      double *real_out,
						      double *imag_out) );
EXTERN_FUNCTION (flag misalign__ds_get_element, (char *datum,
						 unsigned int datum_type,
						 double *value,
						 flag *complex) );
EXTERN_FUNCTION (flag misalign__ds_get_elements, (char *data,
