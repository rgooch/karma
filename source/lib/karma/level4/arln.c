...
/*
  ...
  ch_test_for_io  routine.
    ...
    Last updated by Richard Gooch   1-SEP-1993: Added polling in case where
  ch_stdin  has closed.
...
static flag stdin_input_func (channel, info)
...
static void stdin_close_func (channel, info)
