...
/*  This file contains all routines needed for the management of channel
  ...
  ch_test_for_io  routine.
    ...
    Updated by      Richard Gooch   20-MAY-1994: Moved #include's around.
...
flag (*exception_func) ();
{
    ...
    (void) fprintf (stderr,
		    "WARNING: the  notify_chm_  package will be removed in");
    (void) fprintf (stderr,
		    " Karma version 2.0\nXView support is being dropped:");
    (void) fprintf (stderr, " use Xt instead.\n");
